...
const SAMPLE_APPS = [
  {
    ...
    description: "Sexy Idol app — the naughty girls club · Vote, Live, Chat, Call",
    targetAudience: "FOX Member และ FOXY Creator",
    featured: true,
  ...
  },
  {
    ...
    name: "CupE",
    platformType: "creator-specific",
    description: "แอปไอดอลแนวคิวต์และเลิฟลี่ — เชื่อมต่อเมมเบอร์กับไอดอลผ่าน Vote, Live, Chat, Call",
    targetAudience: "CupE Member และ CupE Creator",
    featured: true,
    logoUrl: "/brand/mrfox-icon.png",
  ...
  },
  {
    ...
    name: "Lesbie",
    platformType: "creator-specific",
    description: "Girl Love Girl app — Fall in love with the right person · Vote, Live, Chat, Call",
    targetAudience: "แฟนคลับ (FC) และไอดอลหญิง LGBT",
    featured: false,
    logoUrl: "/brand/mrfox-icon.png",
  ...
  },
  {
    ...
    name: "BarGirl",
    platformType: "creator-specific",
    description: "Bar Girls app — Hot and stylish girls · Vote, Live, Chat, Call",
    targetAudience: "แฟนชายทั่วโลกและ Bar Girls",
    featured: false,
    logoUrl: "/brand/mrfox-icon.png",
  ...
  },
  {
    ...
    name: "Expat Idols",
    platformType: "creator-specific",
    description: "Expat Models app — worldwide friendships · Vote, Live, Chat, Call",
    targetAudience: "โมเดลต่างชาติในไทยและแฟนคลับ (FC)",
    featured: false,
    logoUrl: "/brand/mrfox-icon.png",
